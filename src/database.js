...
const EduDatabase = {
    ...
    "meter_scale": {
        ...
        formula: "L = x₂ − x₁",
        category: "physics",
        description: "A metre scale is a basic linear measuring instrument used in school and college physics for length, displacement, and ray tracing experiments. Standard scale markings are in centimeters and millimeters.",
        properties: {
            "Use": "Length measurement",
            "Typical Accuracy": "1 mm (0.1 cm)",
            "Standard Length": "1.0 m (100 cm)",
    ...
    "spring_balance": {
        ...
        formula: "F = kx",
        category: "physics",
        description: "A spring balance measures force or weight based on Hooke's Law ($F = -kx$). It consists of an internal tension spring which stretches linearly with the applied load, showing the reading in Newtons and grams.",
        properties: {
            "Use": "Force / weight measurement",
            "Law": "Hooke's Law (Linear stretch)",
            "Least Count": "0.1 N (10 g)",
            "Typical Range": "0–10 N"
        },
        controls: [
            { id: "spring-force", label: "Applied Load", type: "slider", min: 0, max: 10, step: 0.1, value: 5.0, unit: " N" }
        ],
        type: "instrument_spring_balance"
    },
    ...
    "stopwatch": {
        ...
        formula: "t = Δt",
        category: "physics",
        description: "A mechanical stopwatch measures elapsed time intervals in physics experiments like pendulum swings, free fall, and fluid viscosity tests. It features a main dial for seconds and a smaller sub-dial for minutes.",
        properties: {
            "Use": "Time interval measurement",
            "Resolution": "0.1 s",
            "Sectors": "60 seconds, 30 minutes",
            "Application": "Oscillation and mechanics labs"
        },
        controls: [
            { id: "time-interval", label: "Time Interval", type: "slider", min: 0, max: 60, step: 0.1, value: 15.0, unit: " s" }
        ],
        type: "instrument_stopwatch"
    },
    ...
    "ammeter": {
        ...
        formula: "I = V/R",
        category: "physics",
        description: "An ammeter measures electric current in series in an electric circuit. It has an internal shunt resistor to divert major current around the delicate galvanometer movement, providing a low resistance path.",
        properties: {
            "Use": "Current measurement",
            "Connection": "Series (Low internal resistance)",
            "Unit": "Ampere (A)",
            "Least Count": "0.1 A"
        },
        controls: [
            { id: "current", label: "Circuit Current", type: "slider", min: 0, max: 5, step: 0.05, value: 1.8, unit: " A" }
        ],
        type: "instrument_ammeter"
    },
    ...
    "voltmeter": {
        ...
        formula: "V = IR",
        category: "physics",
        description: "A voltmeter measures potential difference in parallel across circuit components. It contains a high resistance coil in series with the galvanometer to ensure negligible current is drawn from the circuit.",
        properties: {
            "Use": "Voltage measurement",
            "Connection": "Parallel (High internal resistance)",
            "Unit": "Volt (V)",
            "Least Count": "0.2 V"
        },
        controls: [
            { id: "voltage", label: "Voltage Reading", type: "slider", min: 0, max: 12, step: 0.1, value: 6.8, unit: " V" }
        ],
    ...
    "galvanometer": {
        ...
        category: "physics",
        description: "A moving coil galvanometer detects and measures weak electrical currents. The center-zero scale displays deflection in both directions, indicating the polarity/direction of current flow.",
        properties: {
            "Use": "Detect small current & direction",
            "Scale Range": "-30 to +30 divisions",
            "Principle": "Magnetic force on current loop",
            "Application": "Wheatstone bridge, null point detection"
        },
        controls: [
            { id: "deflection", label: "Current Deflection", type: "slider", min: -30, max: 30, step: 1, value: 12, unit: " div" }
        ],
        type: "instrument_galvanometer"
    },
    ...
    "multimeter": {
        ...
        category: "physics",
        description: "A digital multimeter combines voltmeter, ammeter, and ohmmeter functions. Selecting a mode via the rotary switch changes internal routing, displaying measurement readouts on the LCD screen.",
        properties: {
            "Use": "Multi-function measurement",
            "Modes": "DC Voltage, DC Current, Resistance",
            "Application": "Circuit troubleshooting, electronics"
        },
        controls: [
            { id: "mode-level", label: "Selector Mode", type: "slider", min: 1, max: 3, step: 1, value: 1, unit: " (V/A/Ω)" },
            { id: "measure-value", label: "Input Signal Strength", type: "slider", min: 0, max: 100, step: 1, value: 45, unit: " %" }
        ],
        type: "instrument_multimeter"
    },
    ...
    "microscope": {
        ...
        formula: "M = m_o × m_e",
        category: "physics",
        description: "A compound microscope uses a lens system of high magnification (objective and eyepiece) to view magnified images of tiny slides. Coarse/fine adjustment knobs are used to focus by shifting the optics tube relative to the stage.",
        properties: {
            "Use": "Microscopic specimen observation",
            "Magnification": "Objective lens × Eyepiece lens",
            "Optics": "Double Convex Lens system",
            "Application": "Biology, material science labs"
        },
        controls: [
            { id: "zoom", label: "Focus Knob Adjustment", type: "slider", min: 0, max: 5, step: 0.1, value: 2.2, unit: " mm" }
        ],
        type: "instrument_microscope"
    },
    ...
    "telescope": {
        ...
        formula: "M = f_o / f_e",
        category: "physics",
        description: "An astronomical refracting telescope consists of two convex lenses: an objective lens of long focal length and an eyepiece of short focal length. It forms highly magnified, inverted virtual images of distant celestial bodies.",
        properties: {
            "Use": "Distant celestial observation",
            "Principle": "Refraction of light rays",
            "Magnification formula": "M = -f_o / f_e",
            "Application": "Astronomy labs"
        },
        controls: [
            { id: "focus", label: "Focus Tube Draw", type: "slider", min: 0.5, max: 2.5, step: 0.05, value: 1.5, unit: " cm" }
        ],
        type: "instrument_telescope"
    },
    ...
    "spectrometer": {
        ...
        formula: "λ = d sin θ / n",
        category: "physics",
        description: "A laboratory spectrometer measures wavelengths of light and refractive indices. It comprises a collimator, a circular graduated scale table to mount a prism or grating, and a rotatable viewing telescope.",
        properties: {
            "Use": "Spectral analysis, refractive index",
            "Principle": "Diffraction/dispersion through prism",
            "Scale": "360° circular Vernier scale",
            "Application": "Wavelength and optics practicals"
        },
        controls: [
            { id: "angle", label: "Telescope Rotation Angle", type: "slider", min: -60, max: 60, step: 0.5, value: 15, unit: "°" }
        ],
        type: "instrument_spectrometer"
    },
    ...
    "spherometer": {
        ...
        formula: "R = l² / 6h + h/2",
        category: "physics",
        description: "A spherometer is used to measure the radius of curvature of spherical surfaces like lenses or mirrors. It relies on a central micrometer screw moving through a three-legged triangular base. The circular dial reads fractional turns.",
        properties: {
            "Use": "Radius of curvature, thickness",
            "Least Count": "0.01 mm (10 μm)",
            "Base Legs Distance (l)": "5.0 cm",
            "Application": "Optics labs"
        },
        controls: [
            { id: "height", label: "Central Screw Height", type: "slider", min: -1.5, max: 3.5, step: 0.01, value: 1.2, unit: " mm" }
        ],
        type: "instrument_spherometer"
    },
    ...
    "travelling_microscope": {
        ...
        category: "physics",
        description: "A travelling microscope is a highly precise laboratory magnifier mounted on horizontal and vertical tracks. It is used to measure small displacements, capillary tube diameters, and refractive index of liquids.",
        properties: {
            "Use": "Precise displacement & size measurement",
            "Least Count": "0.01 mm (0.001 cm)",
            "Track Range": "0-15 cm horizontal & vertical",
            "Application": "Liquid refractive index, small diameter measurement"
        },
        controls: [
            { id: "travel", label: "Microscope Travel Position", type: "slider", min: 0, max: 8, step: 0.02, value: 3.4, unit: " mm" }
        ],
        type: "instrument_travelling_microscope"
    },
    ...
    "resonance_tube": {
        ...
        formula: "v = 4f(L + 0.3d)",
        category: "physics",
        description: "A resonance tube apparatus is used to determine the speed of sound in air by finding resonance points of standing waves. It consists of a vertical graduated water column tube connected to a moveable reservoir to vary air column length.",
        properties: {
            "Use": "Speed of sound, wave nodes/antinodes",
            "Excitation": "Tuning Fork (512 Hz typical)",
            "Harmonics": "First resonance at L ≈ λ/4",
            "Application": "Sound wave resonance practicals"
        },
        controls: [
            { id: "tube-length", label: "Water Level Column Height", type: "slider", min: 0.1, max: 0.9, step: 0.01, value: 0.45, unit: " m" }
        ],
        type: "instrument_resonance_tube"
    },

    "screw_gauge": {
        id: "screw_gauge",
        name: "Micrometer Screw Gauge",
        formula: "Reading = MSR + (HSD × LC)",
        category: "physics",
        description: "A micrometer screw gauge is a high-precision mechanical linear measurement tool. It is used to measure the outer diameter of thin wires or the thickness of glass plates, utilizing a fine-pitch screw mechanism to translate small axial distances into large rotations of the thimble scale.",
        properties: {
            "Use": "Thickness and wire diameter measurement",
            "Pitch": "0.5 mm (one full turn)",
            "Least Count (LC)": "0.01 mm (Circular divisions = 50)",
            "Circular Scale divisions": "50 divisions",
            "Range": "0 to 15.0 mm"
        },
        controls: [
            { id: "gauge-size", label: "Wire Diameter", type: "slider", min: 0, max: 15.0, step: 0.05, value: 4.85, unit: " mm" }
        ],
        type: "instrument_screw_gauge"
    },

    "metre_bridge": {
        id: "metre_bridge",
        name: "Metre Bridge Apparatus",
        formula: "X = R × (100 - l) / l",
        category: "physics",
        description: "A metre bridge (or slide-wire bridge) is an electrical bridge circuit used to measure unknown resistances. It uses a one-meter-long uniform resistance wire stretched over a wooden board. Finding the point on the wire where the galvanometer deflection drops to zero gives the balance length ($l$), allowing calculation of the unknown resistance.",
        properties: {
            "Use": "Measure unknown resistance",
            "Wire Length": "1.0 m (100 cm)",
            "Principle": "Wheatstone Bridge (Balanced condition)",
            "Galvanometer Null point": "l cm from left end"
        },
        controls: [
            { id: "resistance-box", label: "Known Resistance (R)", type: "slider", min: 1, max: 20, step: 1, value: 6, unit: " Ω" },
            { id: "jockey-position", label: "Jockey Slider Location (l)", type: "slider", min: 10, max: 90, step: 0.5, value: 37.5, unit: " cm" }
        ],
        type: "instrument_metre_bridge"
    },
